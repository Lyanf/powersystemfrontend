    ...
    <el-container>
      ...
      <el-main>
        <el-card>
          ...
          <el-row>
            <el-col span=6>
              <el-select value="" v-model="selectedManufacture" placeholder="厂商选择" style="margin-bottom: 10px">
              ...
              <el-checkbox-group v-model="selectedDevices">
                <el-checkbox label="照明插座"></el-checkbox>
                <el-checkbox label="空调用电"></el-checkbox>
                <el-checkbox label="动力用电"></el-checkbox>
  ...
  export default {
    ...
    data: function () {
      return {
        manufacture: '',
        date: '',
        selectedDevices:[ '照明插座', '空调用电', '动力用电','特殊用电'],
        selectedManufacture:''
      }
    },
    mounted() {
